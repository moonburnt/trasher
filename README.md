Because sometimes you need smol bash script to trash useless files from command line... *only to realise later that gio already provides such functionality*...
